...
# 设置文件夹路径
xml_folder = "练习2数据集/Annotations/train"
image_folder = "练习2数据集/JPEGImages/train"
# 设置验证集文件夹路径
val_xml_folder = "练习2数据集/Annotations/val"
val_image_folder = "练习2数据集/JPEGImages/val"

test_image_folder = "练习2数据集/JPEGImages/test"
