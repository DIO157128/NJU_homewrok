...
def main():
    ...
    class_of_task = [20 for i in range(5)]
    ...
    temperature = 2.0
    memory_budget = 1500
    # method = LwF(criterion, device, train_transform, test_transform, class_of_task[0], n_classes, temperature, **kwargs)
    method = iCaRL(criterion, device, train_transform, test_transform, class_of_task[0], n_classes,temperature, memory_budget, **kwargs)
