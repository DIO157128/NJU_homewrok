...
CREATE TABLE `company_account`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '公司账户id',
  `name` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '账户名',
...
-- ----------------------------
INSERT INTO `company_account` VALUES (1, 'account_1', 1000000.00);
INSERT INTO `company_account` VALUES (2, 'account_2', 1000000.00);
INSERT INTO `company_account` VALUES (3, 'account_3', 1000000.00);
...
INSERT INTO `customer` VALUES (2, '销售商', 1, 'lxs', '12580', '南哪儿大学', '123457', '12121@cba.com', 20000000.00, 4431400.00, 1000000.00, 'uncln');
...
CREATE TABLE `pay_sheet`  (
  `id` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '付款单据号',
  `bank_account` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '银行账户',
  ...
  `all_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT '付款总额',
  `create_date` datetime(0) NULL DEFAULT NULL COMMENT '创建日期',
  `payer_id` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `pay_sheet` VALUES ('FKD-20220629-00000', '13245646', '审批完成', 'caiwurenyuan', 134546.00, '2022-06-29 00:00:00', 1);
INSERT INTO `pay_sheet` VALUES ('FKD-20220629-00001', '54646', '审批失败', 'caiwurenyuan', 21321.00, '2022-06-29 00:00:00', 2);
INSERT INTO `pay_sheet` VALUES ('FKD-20220630-00000', 'account_1', '待审批', 'caiwurenyuan', 11111.00, '2022-06-30 00:00:00', 2);
INSERT INTO `pay_sheet` VALUES ('FKD-20220706-00000', 'account_1', '待审批', 'sky', 2.00, '2022-07-06 16:23:42', 1);
...
CREATE TABLE `pay_sheet_content`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '付款内容编号',
  `pay_sheet_id` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '相关付款单据编号',
  `entry_name` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '条目名称',
...
-- ----------------------------
INSERT INTO `pay_sheet_content` VALUES (1, 'FKD-20220629-00000', '供应商', '12', 134540.00);
INSERT INTO `pay_sheet_content` VALUES (2, 'FKD-20220629-00000', '供应商', '34', 6.00);
INSERT INTO `pay_sheet_content` VALUES (57, 'FKD-20220706-00000', '1', '2', 2.00);
...
CREATE TABLE `post`  (
  ...
  `post_name` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '岗位名称',
  `basic_salary` int(0) NULL DEFAULT NULL COMMENT '基本工资',
  `post_salary` int(0) NULL DEFAULT NULL COMMENT '岗位工资',
  `level` int(0) NULL DEFAULT NULL COMMENT '岗位级别',
  `cal_salary_method` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '薪资计算方式',
  `pay_salary_method` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '薪资发放方式',
  `tax_deduction_remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '扣税信息',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
-- Records of post
-- ----------------------------
INSERT INTO `post` VALUES (1, 'INVENTORY_MANAGER', 5000, 5000, 3, 'MONTHLY_SALARY', 'CARD', '无');
INSERT INTO `post` VALUES (2, 'INVENTORY_MANAGER', 5000, 5000, 3, 'MONTHLY_SALARY', 'CARD', '无');
INSERT INTO `post` VALUES (3, 'INVENTORY_MANAGER', 5000, 5000, 3, 'MONTHLY_SALARY', 'CARD', '无');
INSERT INTO `post` VALUES (4, 'SALE_MANAGER', 8000, 8000, 2, 'PERCENTAGE', 'CARD', '无');
INSERT INTO `post` VALUES (5, 'GM', 10000, 10000, 1, 'YEARLY_SALARY', 'CARD', '无');
INSERT INTO `post` VALUES (6, 'SALE_STAFF', 6000, 6000, 3, 'PERCENTAGE', 'CARD', '无');
INSERT INTO `post` VALUES (7, 'GM', 10000, 10000, 1, 'YEARLY_SALARY', 'CARD', '无');
INSERT INTO `post` VALUES (8, 'SALE_MANAGER', 5000, 5000, 2, 'PERCENTAGE', 'CARD', '无');
...
-- ----------------------------
-- Table structure for punch_in_record
-- ----------------------------
DROP TABLE IF EXISTS `punch_in_record`;
CREATE TABLE `punch_in_record`  (
  `staff_id` int(0) NOT NULL COMMENT 'staff主键',
  `staff_name` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '员工姓名',
  `punch_in_time` date NOT NULL COMMENT '打卡日期',
  PRIMARY KEY (`staff_id`, `punch_in_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of punch_in_record
-- ----------------------------
INSERT INTO `punch_in_record` VALUES (1, 'seecoder', '2022-05-30');
INSERT INTO `punch_in_record` VALUES (2, 'uncln', '2022-05-30');
INSERT INTO `punch_in_record` VALUES (3, 'kucun', '2022-05-30');
INSERT INTO `punch_in_record` VALUES (4, 'zxr', '2022-05-30');
INSERT INTO `punch_in_record` VALUES (5, '67', '2022-05-30');
INSERT INTO `punch_in_record` VALUES (6, 'xiaoshou', '2022-05-30');
INSERT INTO `punch_in_record` VALUES (7, 'Leone', '2022-05-30');
INSERT INTO `punch_in_record` VALUES (8, 'xiaoshoujingli', '2022-05-30');
...
CREATE TABLE `receive_sheet`  (
  `id` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '收款单据号',
  `customer_name` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '客户名称',
  `customer_type` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '客户类型',
  `state` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '单据状态',
  `operator` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '操作员',
  `all_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT '收到总额',
...
-- ----------------------------
INSERT INTO `receive_sheet` VALUES ('SKD-20220629-00000', 'lxs', '销售商', '审批完成', 'caiwurenyuan', 12345.00, 5.00, '2022-06-29 00:00:00', 12340.00);
INSERT INTO `receive_sheet` VALUES ('SKD-20220701-00000', 'lxs', '销售商', '待审批', 'caiwurenyuan', 100.00, 1.00, '2022-07-01 22:31:21', 99.00);
INSERT INTO `receive_sheet` VALUES ('SKD-20220701-00001', 'lxs', '销售商', '审批失败', 'caiwurenyuan', 12.00, 1.00, '2022-07-01 21:45:22', 11.00);
...
CREATE TABLE `receive_sheet_content`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '收款内容编号',
  `receive_sheet_id` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '相关收款单据编号',
  `bank_account` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '银行账户',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `transfer_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT '转账金额',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `receive_sheet_content` VALUES (1, 'SKD-20220629-00000', '2316446', '12', 12335.00);
INSERT INTO `receive_sheet_content` VALUES (2, 'SKD-20220629-00000', '2316446', '34', 5.00);
...
CREATE TABLE `salary_sheet`  (
  `id` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '主键',
  `staff_id` int(0) NOT NULL COMMENT '员工ID',
  `staff_name` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '员工姓名',
  `card_account` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '卡账号',
  `due_salary` decimal(10, 2) NOT NULL COMMENT '税前工资',
  `tax` decimal(10, 2) NOT NULL COMMENT '扣除税费',
  `actual_salary` decimal(10, 2) NOT NULL COMMENT '税后工资',
  `state` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '状态',
  `create_date` datetime(0) NOT NULL COMMENT '创建日期',
  `type` int(0) NULL DEFAULT 1 COMMENT '工资单类型，1代表是基本工资，2代表是年终奖',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `salary_sheet` VALUES ('GZD-20220629-00000', 3, 'kucun', '00003', 400.00, 5.00, 398.00, '审批失败', '2022-06-29 00:00:00', 1);
INSERT INTO `salary_sheet` VALUES ('GZD-20220630-00000', 5, '67', '00005', 1000.00, 5.00, 995.00, '审批通过', '2022-06-30 00:00:00', 1);
INSERT INTO `salary_sheet` VALUES ('GZD-20220630-00001', 4, 'zxr', '00004', 500.00, 5.00, 445.00, '待HR审批', '2021-12-01 00:00:00', 2);
INSERT INTO `salary_sheet` VALUES ('GZD-20220630-00002', 6, 'xiaohou', '00006', 6000.00, 90.00, 5910.00, '待总经理审批', '2022-06-30 21:54:36', 1);
INSERT INTO `salary_sheet` VALUES ('GZD-20220706-00007', 1, 'seecoder', '00001', 5013.70, 90.00, 4923.70, '审批通过', '2022-12-01 00:00:01', 2);
INSERT INTO `salary_sheet` VALUES ('GZD-20220706-00008', 2, 'uncln', '00002', 5013.70, 90.00, 4923.70, '审批通过', '2022-12-01 00:00:01', 2);
INSERT INTO `salary_sheet` VALUES ('GZD-20220706-00009', 3, 'kucun', '00003', 5013.70, 90.00, 4923.70, '审批通过', '2022-12-01 00:00:01', 2);
INSERT INTO `salary_sheet` VALUES ('GZD-20220706-00010', 4, 'zxr', '00004', 8000.00, 90.00, 7910.00, '审批通过', '2022-12-01 00:00:01', 2);
INSERT INTO `salary_sheet` VALUES ('GZD-20220706-00011', 5, '67', '00005', 20000.00, 990.00, 19010.00, '审批通过', '2022-12-01 00:00:01', 2);
INSERT INTO `salary_sheet` VALUES ('GZD-20220706-00012', 6, 'xiaoshou', '00006', 6000.00, 90.00, 5910.00, '审批通过', '2022-12-01 00:00:01', 2);
INSERT INTO `salary_sheet` VALUES ('GZD-20220706-00013', 7, 'Leone', '00007', 20000.00, 990.00, 19010.00, '审批通过', '2022-12-01 00:00:01', 2);
INSERT INTO `salary_sheet` VALUES ('GZD-20220706-00014', 8, 'xiaoshoujingli', '00008', 5000.00, 90.00, 4910.00, '审批通过', '2022-12-01 00:00:01', 2);
INSERT INTO `salary_sheet` VALUES ('GZD-20220706-00015', 1, 'seecoder', '00001', 5000.00, 90.00, 4910.00, '待HR审批', '2022-07-06 19:35:46', 1);
INSERT INTO `salary_sheet` VALUES ('GZD-20220706-00016', 2, 'uncln', '00002', 5000.00, 90.00, 4910.00, '待HR审批', '2022-07-06 19:35:46', 1);
INSERT INTO `salary_sheet` VALUES ('GZD-20220706-00017', 3, 'kucun', '00003', 5000.00, 90.00, 4910.00, '待HR审批', '2022-07-06 19:35:46', 1);
INSERT INTO `salary_sheet` VALUES ('GZD-20220706-00018', 4, 'zxr', '00004', 8000.00, 90.00, 7910.00, '待HR审批', '2022-07-06 19:36:33', 1);
INSERT INTO `salary_sheet` VALUES ('GZD-20220706-00019', 6, 'xiaoshou', '00006', 6000.00, 90.00, 5910.00, '待HR审批', '2022-07-06 19:36:33', 1);
INSERT INTO `salary_sheet` VALUES ('GZD-20220706-00020', 8, 'xiaoshoujingli', '00008', 5000.00, 90.00, 4910.00, '待HR审批', '2022-07-06 19:36:33', 1);
...
-- ----------------------------
INSERT INTO `sale_returns_sheet` VALUES ('XSTHD-20220528-00000', 'XSD-20220524-00000', 'xiaoshoujingli', '待二级审批', '2022-05-23 23:22:41', 3359800.00, '退钱！');
...
-- ----------------------------
INSERT INTO `sale_returns_sheet_content` VALUES (23, 'XSTHD-20220528-00000', '0000000000400000', 500, 1750000.00, 3500.00, 'b');
INSERT INTO `sale_returns_sheet_content` VALUES (24, 'XSTHD-20220528-00000', '0000000000400001', 400, 1400000.00, 3500.00, 'b');
...
CREATE TABLE `staff`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '姓名',
  `gender` tinyint(0) NOT NULL COMMENT '性别,1表示男性',
  `birthday` date NULL DEFAULT NULL COMMENT '生日',
  `phone_num` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '电话',
  `post_id` int(0) NULL DEFAULT NULL COMMENT '岗位主键',
  `card_account_id` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '卡账号主键',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of staff
-- ----------------------------
INSERT INTO `staff` VALUES (1, 'seecoder', 1, '2000-01-01', '18900000000', 1, '00001');
INSERT INTO `staff` VALUES (2, 'uncln', 0, '2002-01-01', '18900000001', 2, '00002');
INSERT INTO `staff` VALUES (3, 'kucun', 1, '2003-01-01', '18900000002', 3, '00003');
INSERT INTO `staff` VALUES (4, 'zxr', 0, '2001-01-01', '18900000003', 4, '00004');
INSERT INTO `staff` VALUES (5, '67', 1, '2010-01-01', '18900000004', 5, '00005');
INSERT INTO `staff` VALUES (6, 'xiaoshou', 0, '2002-01-01', '18900000005', 6, '00006');
INSERT INTO `staff` VALUES (7, 'Leone', 1, '2002-01-01', '18900000006', 7, '00007');
INSERT INTO `staff` VALUES (8, 'xiaoshoujingli', 0, '2000-01-01', '18900000007', 8, '00008');
...
CREATE TABLE `user`  (
  ...
  `staff_id` int(0) NULL DEFAULT 0 COMMENT 'staff外键',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'seecoder', '123456', 'INVENTORY_MANAGER', 1);
INSERT INTO `user` VALUES (2, 'uncln', '123456', 'INVENTORY_MANAGER', 2);
INSERT INTO `user` VALUES (3, 'kucun', '123456', 'INVENTORY_MANAGER', 3);
INSERT INTO `user` VALUES (4, 'sky', '123456', 'ADMIN', 0);
INSERT INTO `user` VALUES (5, 'zxr', '123456', 'SALE_MANAGER', 4);
INSERT INTO `user` VALUES (6, '67', '123456', 'GM', 5);
INSERT INTO `user` VALUES (7, 'xiaoshou', '123456', 'SALE_STAFF', 6);
INSERT INTO `user` VALUES (8, 'Leone', '123456', 'GM', 7);
INSERT INTO `user` VALUES (9, 'xiaoshoujingli', '123456', 'SALE_MANAGER', 8);
...
-- ----------------------------
-- Table structure for promotion_strategy_onlevel
-- ----------------------------
drop table if exists `promotion_strategy_onlevel`;
create table `promotion_strategy_onlevel`(
                                             `id` int(0) NOT NULL AUTO_INCREMENT,
                                             `level` int(11)  not null comment'等级' ,
                                             `discount` double default 1 comment'折扣',
                                             `voucher`  int(11) default 0 comment '代金券',
...
insert into `promotion_strategy_onlevel`
values(1,1,1,0,null,null,'2022-2-2 22:59:59') ;
insert into `promotion_strategy_onlevel`
values(2,2,1,0,null,null,'2022-3-3 22:59:59');
insert into `promotion_strategy_onlevel`
values(3,3,1,0,null,null,'2022-4-4 22:59:59');
insert into `promotion_strategy_onlevel`
values(4,4,1,0,null,null,'2022-5-5 22:59:59');
insert into `promotion_strategy_onlevel`
values(5,5,1,0,null,null,'2022-6-6 22:59:59');
insert into `promotion_strategy_onlevel`
values(6,1,1,0,'2022-7-6 00:00:00','2022-8-6 00:00:00',null);


-- ----------------------------
-- Table structure for promotion_strategy_onamount
-- ----------------------------

drop table if exists `promotion_strategy_onamount`;
create table `promotion_strategy_onamount`(
                                              `id` int(0) NOT NULL AUTO_INCREMENT,
                                              `min_amount` int(11)  not null comment'最低价' ,
                                              `max_amount` int(11) not null comment'最高价',
                                              `discount` double default 1 comment'折扣',
                                              `voucher`  int(11) default 0 comment '代金券',
                                              `start_time` datetime comment'开始时间',
                                              `end_time` datetime comment'截止时间',
...
insert into `promotion_strategy_onamount`
values(1,0,100,1,0,null,null,'2022-2-2 22:59:59') ;
insert into `promotion_strategy_onamount`
values(2,101,200,1,0,null,null,'2022-3-3 22:59:59');
insert into `promotion_strategy_onamount`
values(3,201,300,1,0,null,null,'2022-4-4 22:59:59');
insert into `promotion_strategy_onamount`
values(4,301,400,1,0,null,null,'2022-5-5 22:59:59');
...
-- ----------------------------
-- View structure for sale_detail
-- ----------------------------
DROP VIEW IF EXISTS `sale_detail`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `sale_detail` AS select `a`.`id` AS `sheetId`,`a`.`supplier` AS `SellerId`,`a`.`operator` AS `operator`,`a`.`create_time` AS `create_time`,`b`.`pid` AS `pid`,`b`.`quantity` AS `quantity`,`b`.`unit_price` AS `unit_price`,`b`.`total_price` AS `total_price` from (`sale_sheet` `a` join `sale_sheet_content` `b`) where (`a`.`id` = `b`.`sale_sheet_id`) union select `a`.`id` AS `sheetId`,`c`.`supplier` AS `SellerId`,`a`.`operator` AS `operator`,`a`.`create_time` AS `create_time`,`b`.`pid` AS `pid`,`b`.`quantity` AS `quantity`,`b`.`unit_price` AS `unit_price`,`b`.`total_price` AS `total_price` from ((`sale_returns_sheet` `a` join `sale_returns_sheet_content` `b`) join `sale_sheet` `c`) where ((`a`.`id` = `b`.`sale_returns_sheet_id`) and (`a`.`sale_sheet_id` = `c`.`id`));
