...
//    }
     ...
     * 导出excel
     */
    @GetMapping("/warehouse/excel")
    public void getExcel(HttpServletResponse response) throws IllegalAccessException, IOException,
            InstantiationException{
        List<WarehouseCountingVO> list = warehouseService.warehouseCounting();
        DownExcel.download(response,WarehouseCountingVO.class,list,"库存盘点");
    }
