...
public class WarehouseServiceTest {
    ...
    @Transactional
    @Rollback
    public void getWarehouseIODetailByTime_TimeErrorTest() throws ParseException { //测试库存查看，当开始时间大于结束时间时，库存查看的结果应为null
    ...
    @Transactional
    @Rollback
    public void getWarehouseIODetailByTime_EmptyResultTest() throws ParseException { //测试库存查看，指定时间段内没有出入库记录，库存查看的结果应为空数组[]
    ...
    @Transactional
    @Rollback
    public void getWarehouseIODetailByTimeTest() throws ParseException { //测试库存查看,有记录的情况
    ...
    @Transactional
    @Rollback
    public void getWarehouseInputProductQuantityByTime_TimeErrorTest(){ //测试查看一段时间内入库商品的数量,当开始时间大于结束时间时，数量应为0
    ...
    @Transactional
    @Rollback
    public void getWarehouseInputProductQuantityByTime_EmptyResultTest(){ //测试查看一段时间内入库商品的数量,当指定时间段没有入库商品时，数量应为0
    ...
    @Transactional
    @Rollback
    public void getWarehouseInputProductQuantityByTimeTest(){ //测试查看一段时间内入库商品的数量,这段时间内有入库商品的情况
    ...
    @Transactional
    @Rollback
    public void getWarehouseOutProductQuantityByTime_TimeErrorTest(){ //测试查看一段时间内出库商品的数量,当开始时间大于结束时间时，数量应为0
    ...
    @Transactional
    @Rollback
    public void getWarehouseOutProductQuantityByTime_EmptyResultTest(){ //测试查看一段时间内出库商品的数量,当指定时间段没有入库商品时，数量应为0
    ...
    @Transactional
    @Rollback
    public void getWarehouseOutProductQuantityByTimeTest(){  //测试查看一段时间内出库商品的数量,这段时间内有出库商品的情况
