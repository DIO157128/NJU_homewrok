...
export const getAllCustomer = config => request._get(testAPI.CUSTOMER_QUERY_TYPE, config)
export const getAllCustomerReal = config => request._get(testAPI.CUSTOMER_QUERY_ALL, config)
export const getCustomerById = config => request._get(testAPI.CUSTOMER_QUERY_ID, config)
export const addCustomer = config => request._post(testAPI.CUSTOMER_CREATE, config)
