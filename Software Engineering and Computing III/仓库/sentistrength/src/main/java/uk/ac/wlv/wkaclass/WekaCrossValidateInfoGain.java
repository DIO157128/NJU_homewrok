...
public class WekaCrossValidateInfoGain {
    ...
    private static final double E308D = 1.7976931348623157E+308D;
    ...
    public static void main(String args[])
        ...
        int minFeatures = HUNDRED;
        int maxFeatures = THOUSAND;
        int stepFeatures = HUNDRED;
        int iterations = THIRTY;
     ...
     * @param classifierExclude
     * @param addToClasspath
     * @param instructionFilename
     * @param inputFilename
     * @param resultsFileName
     * @param summaryResultsFileName
     */
     ...
     * @param randomSeed
     * @param features
     * @param allResultsFilename
     * @param summaryResultsFilename
     * @return 需要的标签是否比数据的标签少
     * @throws Exception
     */
    public static boolean classifyArff(String arffFileName, String classifierName, String classifierExclude, int randomSeed, int features, String allResultsFilename, String summaryResultsFilename)
        ...
        if (classifierName.indexOf(",liblin,") > 0) {
            try {
                ...
                eval.crossValidateModel(schemeLibLINEAR, data, TEN, new Random(randomSeed), new Object[0]);
        ...
        if (classifierName.indexOf(",libsvm,") > 0) {
            try {
                ...
                eval.crossValidateModel(schemeLibSVM, data, TEN, new Random(randomSeed), new Object[0]);
        ...
        if ((classifierName.indexOf(",smo,") > 0 || classifierName.indexOf(",all,") > 0) && !classifierExclude.equals("SMO")) {
            try {
                ...
                eval.crossValidateModel(schemeSMO, data, TEN, new Random(randomSeed), new Object[0]);
        ...
        if ((classifierName.indexOf(",slog,") > 0 || classifierName.indexOf(",all,") > 0) && !classifierExclude.equals("SLOG")) {
            try {
                ...
                eval.crossValidateModel(schemeSLOG, data, TEN, new Random(randomSeed), new Object[0]);
        ...
        if ((classifierName.indexOf(",bayes,") > 0 || classifierName.indexOf(",all,") > 0) && !classifierExclude.equals("BAYES")) {
            try {
                ...
                eval.crossValidateModel(schemeBayes, data, TEN, new Random(randomSeed), new Object[0]);
        ...
        if ((classifierName.indexOf(",ada,") > 0 || classifierName.indexOf(",all,") > 0) && !classifierExclude.equals("ADA")) {
            try {
                ...
                eval.crossValidateModel(schemeAda, data, TEN, new Random(randomSeed), new Object[0]);
        ...
        if ((classifierName.indexOf(",smoreg,") > 0 || classifierName.indexOf(",all,") > 0) && !classifierExclude.equals("SMOreg")) {
            try {
                ...
                eval.crossValidateModel(schemeSMOreg, data, TEN, new Random(randomSeed), new Object[0]);
        ...
        if ((classifierName.indexOf(",jrip,") > 0 || classifierName.indexOf(",all,") > 0) && !classifierExclude.equals("JRIP")) {
            try {
                ...
                eval.crossValidateModel(schemeJrip, data, TEN, new Random(randomSeed), new Object[0]);
        ...
        if ((classifierName.indexOf(",dec,") > 0 || classifierName.indexOf(",all,") > 0) && !classifierExclude.equals("DEC")) {
            try {
                ...
                eval.crossValidateModel(schemeDec, data, TEN, new Random(randomSeed), new Object[0]);
        ...
        if ((classifierName.indexOf(",j48,") > 0 || classifierName.indexOf(",all,") > 0) && !classifierExclude.equals("J48")) {
            try {
                ...
                eval.crossValidateModel(schemeJ48, data, TEN, new Random(randomSeed), new Object[0]);
